...
Привет! Я Тимур — backend-разработчик с уклоном в создание API, микросервисов и систем обработки данных. Обучаюсь по специальности Data Science, где активно изучаю машинное обучение и работу с данными. Несмотря на это, мой фокус — это **надежный и эффективный backend**.

Моими любимыми темами остаются **линейная алгебра**, **математический анализ** и фундаментальные аспекты программирования. Верю, что прочная математическая база помогает писать более качественный и понятный код.
